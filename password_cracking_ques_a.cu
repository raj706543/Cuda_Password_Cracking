...
/**************************************************************************
  ...
  Compile and run with:
    nvcc -o password_cracking_ques_a password_cracking_ques_a.cu
    ./password_cracking_ques_a 
*****************************************************************************/
...
__device__ int is_a_match(char *attempt) {
  char plain_password1[] = "CV7823";
  char plain_password2[] = "ES8756";
  char plain_password3[] = "HT2434";
  char plain_password4[] = "RD4565";
